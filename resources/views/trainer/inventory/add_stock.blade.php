    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('trainer.inventory')}}">Stock & Inventory</a></li>
                            <li class="breadcrumb-item text-white">/</li>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_inventory" action="{{ route('trainer.add-inventory') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <a href="{{route('trainer.inventory')}}" class="btn-link btn-white"><img style="margin-right:5px" src="{{ asset(config('constants.admin_path').'images/icons/arrow-left.svg')}}" alt="arrow-left">Back</a>
...
function get_variant()
{
    ...
    {
        $.ajax({
            url:"{{route('trainer.select_variant')}}",
            type:"post",
