...
@section('sub_title','Certificates Management')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-end">
                        <div class="table-right-box__info">
                            ...
                            <a href="{{url('trainer/add_certificate')}}" class="btn-link"><i class="ti ti-plus f-16"></i> Add Certificate</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card-body p-0">
                    ...
                    <table id="certificates-management" class="table table-striped nowrap table-wrap">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Image</th>
...
<script>
    $(document).ready(function () {
        var dataTable =	$('#certificates-management').DataTable({
        processing: true,
        serverSide: true,
        'ajax': {
                type : 'POST',
                url : "{{ route('trainer.get-certificates') }}",
                'data': function(data){
