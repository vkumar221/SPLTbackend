   ...
   <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Add Certificate</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_certificate" action="{{ route('trainer.add-certificate') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            <label for="certificate_image">Certificate Image</label><br>
                            <img id="certificate_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <input type="text" class="form-control" name="certificate_title" id="certificate_title" value="{{old('certificate_title')}}" autocomplete="off">
                        </div>
