        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                <div class="trainer-form__wrapper">
                    <form id="add_video" action="{{ route('trainer.add-video') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            <label for="video_image">Thumb Image</label><br>
                            <img id="video_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="upload-container">
                                <div class="youtube-input">
                                    <input type="text" name="video_vimeo" value="{{old('video_vimeo')}}" placeholder="Paste a Vimeo video link" autocomplete="off">
                                ...
                                <div class="youtube-input">
                                    <input type="text" name="video_youtube" value="{{old('video_youtube')}}" placeholder="Paste a YouTube video link" autocomplete="off">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M9.58979 14.3034L8.41128 15.4819C6.7841 17.1091 4.14591 17.1091 2.51873 15.4819C0.891542 13.8547 0.891543 11.2165 2.51873 9.58931L3.69724 8.4108M14.3039 9.58931L15.4824 8.4108C17.1096 6.78362 17.1096 4.14543 15.4824 2.51824C13.8552 0.891056 11.217 0.891056 9.58979 2.51824L8.41128 3.69676M6.08387 11.9167L11.9172 6.08337" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="video_title" id="video_title" value="{{old('video_title')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="video_description" id="video_description" value="{{old('video_description')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="video_date" id="video_date" value="{{old('video_date')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-2">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" name="video_time" id="video_time" value="{{old('video_time')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="video_section" id="video_section">
                                    ...
                                    <option value="{{$video_section->video_section_id}}" @if(old('video_section') == $video_section->video_section_id) selected @endif>{{$video_section->video_section_title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center" style="gap:20px">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="video_status" role="switch" id="flexSwitchCheckChecked" value="1" checked>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label mb-0" for="customCheckclight2">Featured</label>
                                    <input class="form-check-input input-light-secondary" type="checkbox" name="video_featured" id="customCheckclight2" value="1" checked="checked">
                                </div>
                                </div>
                            </div>
                        </div>
