   ...
   <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_workout" action="{{ route('trainer.edit-workout-plan',['id'=>$workout_plan->workout_plan_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="row">
						    ...
						    <div class="row">
							   <div class="col-lg-12">
							      <div class="form-group mb-4">
									 ...
									 <input type="text" class="form-control" name="workout_plan_name" id="workout_plan_name" value="{{$workout_plan->workout_plan_name}}" autocomplete="off">
							   ...
							   <div class="col-lg-6">
							      <div class="form-group mb-4">
									 ...
									 <input type="text" class="form-control" name="workout_plan_duration" id="workout_plan_duration" value="{{$workout_plan->workout_plan_duration}}" autocomplete="off">
                               ...
                               <div class="col-lg-6">
                                    ...
                                    <select class="form-control" name="workout_plan_category" id="workout_plan_category">
                                        ...
                                        <option value="{{$category->workout_category_id}}" @if($workout_plan->workout_plan_category == $category->workout_category_id) selected @endif>{{$category->workout_category_name}}</option>
                                        @endforeach
                                    </select>
							   ...
							   <div class="col-lg-12">
							      <div class="form-group mb-4">
									 ...
									 <textarea rows="3" class="form-control" name="workout_plan_note" id="workout_plan_note">{{$workout_plan->workout_plan_note}}</textarea>
								  </div>
							   </div>
							</div>
						 </div>
                            ...
                            <div class="summary-panel">
                                <div class="exercise-sidebar">
                                    ...
                                    <div class="all-exercise">
                                        <h4>All Exercises</h4>
                                        <input type="hidden" name="exercises" id="exercises" value="{{$exercise_value}}">
                                        <div id="workout_list">
