        ...
        <div class="card my-5">
          <div class="card-body">
            <div class="text-center">
              <a href="{{url('trainer')}}"><img src="{{ asset(config('constants.admin_path').'images/logo.png') }}" alt="img" /></a>
            </div>

            <div class="saprator my-3"></div>
            <h4 class="text-center f-w-500 mb-3 text-white">Trainer Login </h4>
            <form action="{{route('trainer.authenticate-login')}}" method="POST">
              ...
              {{-- <div class="d-flex mt-1 justify-content-between align-items-center">
                ...
                <h6 class="text-secondary f-w-400 mb-0">
                  <a href="{{url('trainer/forgot_password')}}" class="text-white">Forgot Password?</a>
                </h6>
              </div> --}}
