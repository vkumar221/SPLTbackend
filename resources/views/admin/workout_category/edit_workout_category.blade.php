    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-white">/</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Workout Category</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_workout_category" action="{{ route('admin.edit-workout-category',['id'=>$workout_category->workout_category_id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                        <label for="workout_category_name">Workout Category name</label>
                        <input type="text" class="form-control" name="workout_category_name" value="{{$workout_category->workout_category_name}}" id="workout_category_name">
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        @if($workout_category->workout_category_image != NULL)
                        <img class="mb-2" id="workout_category_image_src" src="{{ asset(config('constants.admin_path').'uploads/workout_category/'.$workout_category->workout_category_image)}}" alt="placeholder" width="100">
                        @else
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        @if($workout_category->workout_category_cover_image != NULL)
                        <img class="mb-2" id="workout_category_cover_image_src" src="{{ asset(config('constants.admin_path').'uploads/workout_category/'.$workout_category->workout_category_cover_image)}}" alt="placeholder" width="100">
                        @else
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        @if($workout_category->workout_category_feature_image != NULL)
                        <img class="mb-2" id="workout_category_feature_image_src" src="{{ asset(config('constants.admin_path').'uploads/workout_category/'.$workout_category->workout_category_feature_image)}}" alt="placeholder" width="100">
                        @else
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <textarea name="workout_category_description" class="form-control" id="classic-editor">{{$workout_category->workout_category_description}}</textarea>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
