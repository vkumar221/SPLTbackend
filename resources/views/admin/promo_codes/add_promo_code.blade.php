    ...
    <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_promo_code" action="{{ route('admin.add-promo-code') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <label for="promo_code_name">Coupon Code</label>
                                <input type="text" class="form-control" name="promo_code_name" id="promo_code_name" value="{{old('promo_code_name')}}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="promo_code_type" id="promo_code_type">
                                    <option value="1" @if(old('promo_code_type') == 1) selected @endif>Fixed Amount</option>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="promo_code_value" id="promo_code_value" value="{{old('promo_code_value')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="promo_code_max_order_value" id="promo_code_max_order_value" value="{{old('promo_code_max_order_value')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="promo_code_min_order_value" id="promo_code_min_order_value" value="{{old('promo_code_min_order_value')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="promo_code_from" id="promo_code_from" value="{{old('promo_code_from')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="promo_code_to" id="promo_code_to" value="{{old('promo_code_to')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="promo_code_usage" id="promo_code_usage" value="{{old('promo_code_usage')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="promo_code_max_users" id="promo_code_max_users" value="{{old('promo_code_max_users')}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <img id="promo_code_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
