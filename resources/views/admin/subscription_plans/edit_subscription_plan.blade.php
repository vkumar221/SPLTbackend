    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-white">/</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Subscription Plan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_subscription_plan" action="{{ route('admin.edit-subscription-plan',['id'=>$subscription_plan->subscription_plan_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <label for="subscription_plan_title">Coupon Plan</label>
                                <input type="text" class="form-control" name="subscription_plan_title" id="subscription_plan_title" value="{{$subscription_plan->subscription_plan_title}}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="subscription_plan_popular" id="subscription_plan_popular">
                                    <option value="1" @if($subscription_plan->subscription_plan_popular == 1) selected @endif>No</option>
                                    <option value="2" @if($subscription_plan->subscription_plan_popular == 2) selected @endif>Yes</option>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="subscription_plan_price" id="subscription_plan_price" value="{{ $subscription_plan->subscription_plan_price }}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                <label for="subscription_plan_discount">Discount</label>
                                <input type="text" class="form-control" name="subscription_plan_discount" id="subscription_plan_discount" value="{{$subscription_plan->subscription_plan_discount}}" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="subscription_plan_description" id="subscription_plan_description" autocomplete="off">{{$subscription_plan->subscription_plan_description}}</textarea>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                @if($subscription_plan->subscription_plan_image != NULL)
                                <img class="mb-2" id="subscription_plan_image_src" src="{{ asset(config('constants.admin_path').'uploads/subscription_plan/'.$subscription_plan->subscription_plan_image)}}" alt="placeholder" width="68">
                                @else
                                <img id="subscription_plan_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="100">
                                @endif
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <tr class="checked-row">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input input-info" type="checkbox" id="plan_item_{{$item->plan_item_id}}" name="plan_item[{{$item->plan_item_id}}]" value="{{$item->plan_item_id}}" @if(isset($sub_plan_items) && in_array($item->plan_item_id,$sub_plan_items)) checked @endif>
                                        <label for="plan_item_{{$item->plan_item_id}}" class="form-check-label">{{$item->plan_item_name}}</label>
                                    </div>
                                    </td>
                                </tr>
                                @endforeach
