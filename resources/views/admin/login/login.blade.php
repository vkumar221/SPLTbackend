        ...
        <div class="card my-5">
          <div class="card-body">
            <div class="text-center">
              <a href="{{url('admin')}}"><img src="{{ asset(config('constants.admin_path').'images/logo.png') }}" alt="img" /></a>
            </div>
            ...
            <form action="{{route('admin.authenticate-login')}}" method="POST">
                @csrf
              <div class="mb-3">
              ...
              {{-- <div class="d-flex mt-1 justify-content-between align-items-center">
                ...
                <h6 class="text-secondary f-w-400 mb-0">
                  <a href="{{url('admin/forgot_password')}}" class="text-white">Forgot Password?</a>
                </h6>
              </div> --}}
