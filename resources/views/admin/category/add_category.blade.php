    ...
    <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_category" action="{{ route('admin.add-category') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <img id="category_cover_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68">
                        <div class="custom-file-wrapper">
                            <span class="file-name"></span>
                            <button type="button" class="browse-btn">Browse</button>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <img id="category_feature_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68">
                        <div class="custom-file-wrapper">
                            <span class="file-name"></span>
                            <button type="button" class="browse-btn">Browse</button>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <textarea name="category_description" class="form-control" id="classic-editor"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
