    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-white">/</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Attribute</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_attribute" action="{{ route('admin.edit-attribute',['id'=>$attribute->attribute_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                        <label for="attribute_name">Attribute name</label>
                        <input type="text" class="form-control" name="attribute_name" id="attribute_name" value="{{$attribute->attribute_name}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <input type="text" class="form-control" name="attribute_type" id="attribute_type" value="{{$attribute->attribute_type}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="attribute_category" id="attribute_category">
                            ...
                            <option value="{{$category->category_id}}" @if($attribute->attribute_category == $category->category_id) selected @endif>{{$category->category_name}}</option>
                            @endforeach
                        </select>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="variations-table">
                            ...
                            <tbody>
                                @if($attribute_variations->count() > 0)
                                    @php
                                    $count = 1;
                                    @endphp
                                    @foreach($attribute_variations as $variation)
                                    <tr>
                                    <td><input type="text" class="form-control" name="attribute_variation_name[{{$variation->attribute_variation_id}}]" id="attribute_variation_name{{$variation->attribute_variation_id}}" value="{{$variation->attribute_variation_name}}" autocomplete="off"></td>
                                    <td><input type="text" class="form-control" name="attribute_variation_value[{{$variation->attribute_variation_id}}]" id="attribute_variation_value{{$variation->attribute_variation_id}}" value="{{$variation->attribute_variation_value}}" autocomplete="off"></td>
                                    <td><a href="{{url('admin/attribute_variation_delete/'.$variation->attribute_variation_id)}}" class="remove-btn" ><img src="{{ asset(config('constants.admin_path').'images/icons/trash-blue.svg')}}" alt="trash"></button></td>
                                    </tr>
                                    @php
                                    $count++;
                                    @endphp
...
<script>
    ...
    <script>
        ...
        input.editEventListener('change', function () {
    ...
    <script>
        ...
        newRow.innerHTML = `
            <td><input type="text" class="form-control" name="attribute_variation_name_edit[`+newCount+`]" id="attribute_variation_name`+newCount+`" autocomplete="off"></td>
            <td><input type="text" class="form-control" name="attribute_variation_value_edit[`+newCount+`]" id="attribute_variation_value`+newCount+`" autocomplete="off"></td>
            <td>
