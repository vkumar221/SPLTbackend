                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">All Vendors</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6 text-end">
                        <div class="table-right-box__info">
                            ...
                            <a href="{{url('admin/add_vendor')}}" class="btn-link"><i class="ti ti-plus f-16"></i> Add Vendor</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card-body p-0">
                    ...
                    <table id="vendors-management" class="table table-striped nowrap table-wrap">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Name</th>
...
<script>
    $(document).ready(function () {
        var dataTable =	$('#vendors-management').DataTable({
        processing: true,
        serverSide: true,
        'ajax': {
                type : 'POST',
