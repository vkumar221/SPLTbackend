    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-white">/</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Vendor</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_vendor" action="{{ route('admin.edit-vendor',['id'=>$vendor->vendor_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                        <label for="vendor_name">Vendor name</label>
                        <input type="text" class="form-control" name="vendor_name" id="vendor_name" value="{{$vendor->vendor_name}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" class="form-control" name="vendor_email" id="vendor_email" value="{{$vendor->vendor_email}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" class="form-control" name="vendor_phone" id="vendor_phone" value="{{$vendor->vendor_phone}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <select class="form-control" name="vendor_type" id="vendor_type">
                            <option value="1" @if($vendor->vendor_type == 1) selected @endif>New</option>
                            <option value="2" @if($vendor->vendor_type == 2) selected @endif>Existing</option>
                        </select>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="password" class="form-control" name="vendor_password" id="vendor_password" value="" autocomplete="off">
                        </div>
                        @if($errors->has('vendor_phone'))
                        <p class="text-danger">{{ $errors->first('vendor_phone') }}</p>
                        @endif
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <img id="vendor_image_src" class="mb-2" src="{{ asset(config('constants.vendor_path').'uploads/profile/'.$vendor->vendor_image)}}" alt="placeholder" width="100">
