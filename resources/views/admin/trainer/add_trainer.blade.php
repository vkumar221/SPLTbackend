    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-white">/</li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Add Trainer</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_trainer" action="{{ route('admin.add-trainer') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                        <label for="trainer_name">Trainer name</label>
                        <input type="text" class="form-control" name="trainer_name" id="trainer_name" value="{{old('trainer_name')}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" class="form-control" name="trainer_email" id="trainer_email" value="{{old('trainer_email')}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" class="form-control" name="trainer_phone" id="trainer_phone" value="{{old('trainer_phone')}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <select class="form-control" name="trainer_type" id="trainer_type">
                            <option value="1" @if(old('trainer_type') == 1) selected @endif>New</option>
                            <option value="2" @if(old('trainer_type') == 2) selected @endif>Existing</option>
                        </select>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <input type="password" class="form-control" name="trainer_password" id="trainer_password" value="{{old('trainer_password')}}" autocomplete="off">
                        </div>
                        @if($errors->has('trainer_phone'))
                        <p class="text-danger">{{ $errors->first('trainer_phone') }}</p>
                        @endif
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <img id="trainer_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
