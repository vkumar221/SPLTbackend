    ...
    <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_product" action="{{ route('admin.edit-product',['id'=>$product->product_id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <select class="form-control" name="product_vendor" id="product_vendor">
                            ...
                            <option value="{{$vendor->vendor_id}}" @if($product->product_vendor == $vendor->vendor_id) selected @endif>{{$vendor->vendor_name}}</option>
                            @endforeach
                        </select>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <img class="mb-2" id="product_image_src" src="{{ asset(config('constants.vendor_path').'uploads/product/'.$product->product_image)}}" alt="product" width="68">
                        @else
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <textarea name="product_description" class="form-control classic-editor">{{$product->product_description}}</textarea>
                        </div>
                    </div>
                    @if(count($variants) > 0)
                    <h4>Variants</h4>
