      ...
      <div class="card" style="background-color:transparent;border-color:unset;border: none;">
         <div class="card-body p-0">
            <div class="form-wrapper">
               <form id="add_product" action="{{ route('admin.add-product') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                  @csrf
                  <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="product_vendor" id="product_vendor">
                              ...
                              <option value="{{$vendor->vendor_id}}" @if(old('product_vendor') == $vendor->vendor_id) selected @endif>{{$vendor->vendor_name}}</option>
                              @endforeach
                           </select>
                        </div>
                        @if($errors->has('product_vendor'))
                        <p class="text-danger">{{ $errors->first('product_vendor') }}</p>
                        @endif
                     </div>
                     <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                     ...
                     <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              ...
                              --}}
                              <input type="text" class="form-control" name="product_offer_price" id="product_offer_price" value="{{old('product_offer_price')}}" autocomplete="off">
                           </div>
                     ...
                     <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                           ...
                           <textarea name="product_description" class="form-control classic-editor">{{old('product_description')}}</textarea>
                        </div>
                     </div>
                     <h4>Variants</h4>
                     <div id="repeat">
                     ...
                     <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-action__button">
                           <a href="{{route('admin.products')}}" class="btn-link btn-white"><img style="margin-right:5px" src="{{ asset(config('constants.admin_path').'images/icons/arrow-left.svg')}}" alt="arrow-left">Back</a>
   ...
   function select_attribute(id)
    {
        ...
        {
            $.ajax({
                    url: "{{ url('admin/select_attribute') }}",
                    type: "post",
