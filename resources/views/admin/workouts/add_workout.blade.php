   ...
   <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Add Workout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_workout" action="{{ route('admin.add-workout') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            <label for="workout_image">Workout Image</label><br>
                            <img id="workout_image_src" class="mb-2" src="{{ asset(config('constants.admin_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
                    ...
                    {{-- <div class="col-lg-12">
                        <div class="form-group image-container">
                            <label class="upload-box" for="fileInput" style="background: #9D88C9;">
                            <div class="upload-text" id="uploadText">
                                <div class="icon"><img src="assets/images/icons/circle-plus.svg" alt="add"></div>
                                <p class="text-white">Drop an Image here</p>
                                <span class="text-white">You can upload Images with a maximum size of 100 MB.</span>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <input type="text" class="form-control" name="workout_name" id="workout_name" value="{{old('workout_name')}}" autocomplete="off">
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="workout_type" id="workout_type">
                            ...
                            <option value="{{$exercise_type->exercise_type_id}}" @if(old('workout_type') == $exercise_type->exercise_type_id) selected @endif>{{$exercise_type->exercise_type_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="workout_equipment" id="workout_equipment">
                            ...
                            <option value="{{$equipment->equipment_id}}" @if(old('workout_equipment') == $equipment->equipment_id) selected @endif>{{$equipment->equipment_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="workout_muscle_group" id="workout_muscle_group">
                            ...
                            <option value="{{$muscle_group->muscle_group_id}}" @if(old('workout_muscle_group') == $muscle_group->muscle_group_id) selected @endif>{{$muscle_group->muscle_group_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="workout_other_muscle" id="workout_other_muscle">
                            <option value="">Select...</option>
                            @foreach($muscle_groups as $muscle_group)
                            <option value="{{$muscle_group->muscle_group_id}}" @if(old('workout_other_muscle') == $muscle_group->muscle_group_id) selected @endif>{{$muscle_group->muscle_group_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <select class="form-control" name="workout_category" id="workout_category">
                            ...
                            <option value="{{$category->workout_category_id}}" @if(old('workout_category') == $category->workout_category_id) selected @endif>{{$category->workout_category_name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="upload-container">
                                <div class="youtube-input workout-inp">
                                    <input type="text" placeholder="Paste a Vimeo video link" name="workout_vimeo" id="workout_vimeo" value="{{old('workout_vimeo')}}" autocomplete="off">
                                ...
                                <div class="youtube-input workout-inp">
                                    <input type="text" placeholder="Paste a YouTube video link" name="workout_youtube" id="workout_youtube" value="{{old('workout_youtube')}}" autocomplete="off">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M9.58979 14.3034L8.41128 15.4819C6.7841 17.1091 4.14591 17.1091 2.51873 15.4819C0.891542 13.8547 0.891543 11.2165 2.51873 9.58931L3.69724 8.4108M14.3039 9.58931L15.4824 8.4108C17.1096 6.78362 17.1096 4.14543 15.4824 2.51824C13.8552 0.891056 11.217 0.891056 9.58979 2.51824L8.41128 3.69676M6.08387 11.9167L11.9172 6.08337" stroke="#9DA4AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <a href="{{route('admin.workouts')}}" class="btn-link btn-white"><img style="margin-right:5px" src="{{ asset(config('constants.admin_path').'images/icons/arrow-left.svg')}}" alt="arrow-left">Back</a>
