    ...
    <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="add_brand" action="{{ route('admin.add-brand') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                    <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <textarea name="brand_description" class="form-control" id="classic-editor"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
