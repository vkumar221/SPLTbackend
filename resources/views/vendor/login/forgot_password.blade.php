   ...
   <div class="auth-main">
    <div class="auth-wrapper v2">
      <div class="auth-sidecontent">
        <img src="{{ asset(config('constants.vendor_path').'images/authentication/img-auth-sideimg.jpg') }}" alt="images" class="img-fluid img-auth-side" />
      </div>
      <div class="auth-form">
        <div class="card my-5">
          <div class="card-body">
            <div class="text-center">
              <a href="{{url('vendor')}}"><img src="{{ asset(config('constants.vendor_path').'images/logo.png') }}" alt="img" /></a>
            </div>
            ...
            <form action="{{route('vendor.authenticate-login')}}" method="POST">
              ...
              <div class="d-flex mt-1 justify-content-between align-items-center">
                ...
                <h6 class="text-secondary f-w-400 mb-0">
                  <a href="{{url('vendor')}}" class="text-white">Remember Password ?</a>
                </h6>
              </div>
