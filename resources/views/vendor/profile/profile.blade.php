    ...
    <div class="pc-content">
        ...
        <div class="card" style="background-color:transparent;border-color:unset;border: none;">
            <div class="card-body p-0">
                ...
                <form id="edit_vendor" action="{{ route('vendor.profile') }}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <img class="mb-2" id="vendor_image_src" src="{{ asset(config('constants.vendor_path').'uploads/profile/'.Auth::guard('vendor')->user()->vendor_image)}}" alt="placeholder" width="68">
                            @else
                            <img id="vendor_image_src" class="mb-2" src="{{ asset(config('constants.vendor_path').'images/placeholder.png')}}" alt="placeholder" width="68" height="68">
                            @endif
                            ...
                            <p class="text-danger">{{ $errors->first('vendor_image') }}</p>
                            @endif
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" name="vendor_name" value="{{Auth::guard('vendor')->user()->vendor_name}}" id="vendor_name" autocomplete="off">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" name="vendor_email" value="{{Auth::guard('vendor')->user()->vendor_email}}" id="vendor_email" autocomplete="off">
                            </div>
