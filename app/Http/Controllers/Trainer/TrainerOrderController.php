...
class TrainerOrderController extends Controller
{
    ...
    {
        $data['set'] = 'orders';
        return view('trainer.order.orders',$data);
    }
        ...
        if($request->ajax())
        {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '<a href="'.url('trainer/edit_order/'.$row->order_id).'" class="btn btn-icon btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a> ';
    ...
    public function edit_order(Request $request)
    {
        ...
        $data['set'] = 'orders';
        return view('trainer.order.edit_order',$data);
    }
    ...
    public function invoice_download(Request $request)
    {
        ...
        $pdf = PDF::loadView('trainer.order.invoice_download', $data);
