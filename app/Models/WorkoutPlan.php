...
class WorkoutPlan extends Model
{
    ...
    protected $fillable = ['workout_plan_name','workout_plan_category','workout_plan_duration','workout_plan_note','workout_plan_status','workout_plan_added_by','workout_plan_added_on','workout_plan_updated_by','workout_plan_updated_on'];
