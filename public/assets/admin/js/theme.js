    ...
    "true" == e
        ? (document.getElementsByTagName("body")[0].setAttribute("data-pc-sidebar-caption", "true"),
          document.querySelector(".theme-nav-caption .btn.active") &&
              (document.querySelector(".theme-nav-caption .btn.active").classList.remove("active"), document.querySelector(".theme-nav-caption .btn[data-value='true']").classList.add("active")))
        : (document.getElementsByTagName("body")[0].setAttribute("data-pc-sidebar-caption", "false"),
          document.querySelector(".theme-nav-caption .btn.active") &&
              (document.querySelector(".theme-nav-caption .btn.active").classList.remove("active"), document.querySelector(".theme-nav-caption .btn[data-value='false']").classList.add("active")));
}
function preset_change(e) {
    document.getElementsByTagName("body")[0].setAttribute("data-pc-preset", e),
        document.querySelector(".pct-offcanvas") && (document.querySelector(".preset-color > a.active").classList.remove("active"), document.querySelector(".preset-color > a[data-value='" + e + "']").classList.add("active"));
}
function layout_rtl_change(e) {
    ...
    "true" === e
        ? ((rtl_flag = !0),
          ...
          o && (o.classList.remove("active"), document.querySelector(".theme-direction .btn[data-value='true']").classList.add("acxtive")))
        : ((rtl_flag = !1),
          t.setAttribute("data-pc-direction", "ltr"),
          a.removeAttribute("dir"),
          a.removeAttribute("lang"),
          o && (o.classList.remove("active"), document.querySelector(".theme-direction .btn[data-value='false']").classList.add("active")));
}
function layout_change(e) {
    ...
    t && t.classList.remove("active"),
        "dark" === e
            ? ((dark_flag = !0),
              updateLogo(".pc-sidebar .m-header .logo-lg", "assets/images/sidelogo.png"),
              updateLogo(".navbar-brand .logo-lg", "https://ableproadmin.com/assets/images/logo-white.svg"),
              updateLogo(".auth-main.v1 .auth-sidefooter img", "https://ableproadmin.com/assets/images/logo-white.svg"),
              updateLogo(".footer-top .footer-logo", "https://ableproadmin.com/assets/images/logo-white.svg"),
              updateActiveButton('.theme-layout .btn[data-value="false"]'))
            : ((dark_flag = !1),
              updateLogo(".pc-sidebar .m-header .logo-lg", "assets/images/sidelogo.png"),
              updateLogo(".navbar-brand .logo-lg", "https://ableproadmin.com/assets/images/logo-dark.svg"),
              updateLogo(".auth-main.v1 .auth-sidefooter img", "https://ableproadmin.com/assets/images/logo-dark.svg"),
              updateLogo(".footer-top .footer-logo", "https://ableproadmin.com/assets/images/logo-dark.svg"),
    ...
    o &&
        ...
        ("true" === e
            ? (o.classList.add("container"),
              ...
              (t = document.querySelector(".theme-container .btn.active")) && t.classList.remove("active"),
              (a = document.querySelector('.theme-container .btn[data-value="true"]')) && a.classList.add("active"))
            : (o.classList.remove("container"),
              c.classList.remove("container"),
              c.classList.add("container-fluid"),
              (t = document.querySelector(".theme-container .btn.active")) && t.classList.remove("active"),
              (a = document.querySelector('.theme-container .btn[data-value="false"]')) && a.classList.add("active")));
}
document.addEventListener("DOMContentLoaded", function () {
